<%@ Page Title="" Language="C#" MasterPageFile="~/Galeri.Master" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="RentACarWebApp.main" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row text-center">
        ...
        <div class="card col-3 bg-primary text-light text-center m-3 p-2">
            ...
            <br />
            <a href="modeller.aspx?markaadi=mercedes" class="btn btn-light w-75 btn-outline-success">
